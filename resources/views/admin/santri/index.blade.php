                ...
                <div class="modal-body">
                    <form action="" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="inputAddress" name="tahun_akademik"
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select class="form-control" id="pekerjaan_ayah" name="pekerjaan_ayah">
                                    <option>Santri MADIN</option>
                                    <option>Santri PAUD</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" id="NamaIbu" name="nama_ibu" placeholder="Nama Ibu">
                            </div>
                            <div class="form-group col-md-6">
